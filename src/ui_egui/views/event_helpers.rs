//! Event helper utilities for calendar views.
//!
//! Extracted from `views/mod.rs` — shared event filtering, ribbon lane
//! calculation, sync-event detection, and countdown menu state logic.
...
use super::{CountdownMenuState, CountdownRequest};
